...
import anymind.henry.posrelatedservice.paymentmethod.Amex
import org.junit.jupiter.api.Assertions.*
import org.junit.jupiter.api.Test


internal class AmexTest {
    private val payment = Amex()
    ...
    fun shouldBeFalseDuetoWrongValue3() {
        val additionalItem = HashMap<String, Any>()
        additionalItem.put(LAST_4_KEY, "123")
    ...
    fun shouldBeFalseDuetoWrongModifier1() {
        ...
        val errList = payment.checkValidation(0.97f, additionalItem)
    ...
    fun shouldBeFalseDuetoWrongModifier2() {
        ...
        val errList = payment.checkValidation(1.02f, additionalItem)
        assertEquals(false, errList.isEmpty())
        assertEquals(true, errList.contains(NOT_IN_POSSIBLE_RANGE))
    }
